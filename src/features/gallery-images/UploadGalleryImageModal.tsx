...
export default function UploadGalleryImageModal({ open, onClose }: UploadGalleryImageModalProps) {
  ...
  const { mutateAsync: createGalleryImage, isPending: submitting } = useCreateGalleryImage();
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Foundation members doing charity work"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              placeholder="Donation distribution event — August 2024"
            />
          </div>
